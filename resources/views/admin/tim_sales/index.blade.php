    ...
    <div class="container mx-auto p-6">
        ...
        <div class="flex items-center justify-between mb-8">
            ...
            <div class="flex items-center space-x-4">
                <form method="GET" action="{{ route('tim_sales.index') }}">
                    <div class="relative">
                        <input type="text" 
                            name="search" 
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                               <a href="{{ route('tim_sales.edit', $item->id_tim_sales) }}"
                                class="text-gray-600 hover:text-gray-900">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
                                </a>
                                <button onclick="openModal('{{ route('tim_sales.destroy', $item->id_tim_sales) }}', 'Hapus Tim Sales', 'Apakah Kamu Yakin Ingin Menghapus Tim Sales Ini?')" 
