...
@section('content')
@section('title', 'Edit Tim Sales')

<div class="container mx-auto p-6">
    <!-- Header with Back and Actions -->
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-2xl font-semibold">Edit Nama Tim Sales</h1>
            <p class="text-sm text-gray-500 mt-1">Perbarui Nama Tim Sales</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-xl shadow-sm">
        <form action="{{ route('tim_sales.update', $tim_sales->id_tim_sales) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('nama_tim_sales', $tim_sales->nama_tim_sales) }}"
