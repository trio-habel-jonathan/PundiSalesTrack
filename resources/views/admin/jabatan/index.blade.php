...
<div class="container mx-auto p-6">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-2xl font-semibold">Kelola Jabatan Sales</h1>
            <p class="text-sm text-gray-500 mt-1">Kelola Jabatan dalam satu tampilan</p>
        </div>
        ...
        <div class="flex items-center space-x-4">
            <form method="GET" action="{{ route('jabatan.index') }}">
                <div class="relative">
                    <input type="text" 
                           ...
                           placeholder="Cari Jabatan Sales..." 
            ...
            <a href="{{ route('jabatan.create') }}" 
               class="px-4 py-2 bg-black text-white rounded-lg flex items-center space-x-2 hover:bg-gray-900 transition-colors duration-200">
                ...
                <span>Tambah Jabatan Sales</span>
            </a>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                            ...
                            <button onclick="openModal('{{ route('jabatan.destroy', $item->id_jabatan) }}', 'Hapus Jabatan Sales', 'Apakah Kamu Yakin Ingin Menghapus Jabatan Ini?')" 
                    ...
                    <tr>
                        <td colspan="4" class="px-6 py-4 whitespace-nowrap text-sm text-gray-500 text-center">
                           Tidak ada jabatan sales yang ditemukan.
                        </td>
                    </tr>
                    @endforelse
                </tbody>
