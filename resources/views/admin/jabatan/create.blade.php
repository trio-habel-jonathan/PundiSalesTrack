...
<div class="container mx-auto p-6">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-2xl font-semibold">Buat Jabatan Sales</h1>
            <p class="text-sm text-gray-500 mt-1">Tambahkan Jabatan Sales Dalam Sistem</p>
        </div>
    </div>

    <!-- Form Card -->
    <div class="bg-white rounded-xl shadow-sm">
        <form action="{{ route('jabatan.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 gap-6">
                ...
                <div>
                    ...
                    required>{{ old('deskripsi_jabatan') }}</textarea>
