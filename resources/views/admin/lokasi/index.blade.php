...
<div class="container mx-auto p-6">
    ...
    <div class="flex items-center justify-between mb-8">
        <div>
            <h1 class="text-2xl font-semibold">Kelola Lokasi</h1>
            <p class="text-sm text-gray-500 mt-1">Kelola Lokasi dalam satu tampilan</p>
        </div>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                            ...
                            <button onclick="openModal('{{ route('lokasi.destroy', $item->id_lokasi) }}', 'Hapus Lokasi', 'Apakah Kamu Yakin Ingin Menghapus Lokasi Ini?')" 
