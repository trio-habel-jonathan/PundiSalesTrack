...
<div class="container mx-auto p-6">
    <div class="flex items-center justify-between mb-8">
        <div>
            ...
            <p class="text-sm text-gray-500 mt-1">Kelola produk dalam satu tampilan</p>
        </div>
        ...
        <div class="flex items-center space-x-4">
            ...
            <a href="{{ route('produk.create') }}" class="px-4 py-2 bg-black text-white rounded-lg flex items-center space-x-2 hover:bg-gray-900 transition-colors duration-200">
        ...
        <div class="bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow duration-200 flex items-center p-6">
            ...
            <div class="flex-1">
                ...
                <div class="mt-4 flex space-x-2">
                    <a href="{{ route('produk.detail',$item->id_produk) }}" class="text-gray-600 hover:text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
                        </svg>
                    </a>
                    <a href="{{ route('produk.edit',$item->id_produk) }}" class="text-gray-600 hover:text-gray-900">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                        </svg>
                    </a>
                    <button onclick="openModal('{{ route('produk.destroy', $item->id_produk) }}', 'Hapus Produk', 'Apakah Kamu Yakin Ingin Menghapus Produk Ini?')" 
